...
def main():
    df_fluxes = pd.read_hdf('data/sdss/preprocessed/0-50_o_fluxes.h5', key='fluxes').head(10000)
    df_source_info = pd.read_hdf('data/sdss/preprocessed/0-50_o_fluxes.h5', key='spectral_data').head(10000)
    df_wavelengths = pd.read_hdf('data/sdss/preprocessed/0-50_o_fluxes.h5', key='wavelengths')
